          ...
          <table className="min-w-full text-left text-sm">
            ...
            <tbody>
              {result.items.map((item) => (
                <tr key={item.item_code} className="border-b border-zinc-50 last:border-0">
                  <td className="px-3 py-3 font-medium text-zinc-900">{item.item_code}</td>
                  <td className="px-3 py-3 text-zinc-700">{item.description}</td>
                  <td className="px-3 py-3 text-zinc-700">{item.size}</td>
                  <td className="px-3 py-3 text-zinc-700">{item.schedule}</td>
